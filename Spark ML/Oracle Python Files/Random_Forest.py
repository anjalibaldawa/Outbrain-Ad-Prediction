...
# MAGIC %md ## Creating a Classification Model using Random Forest Algorithm
# MAGIC 
# MAGIC In this file, we will implement a classification model using *Random Forest* that uses features of a Event,Document and Train dataframe to **predict the whether the ad is clicked or not** 
# MAGIC 
...
# MAGIC 7. Build a ***Random Forest Algorithm*** Model with the label and features
...
# MAGIC %md #### Random Forest Evaluator
# MAGIC Calculate AUC using Random Forest Evaluator.
...
# MAGIC %md #### Random Forest Confusion matrix
